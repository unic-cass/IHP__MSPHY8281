...
C {and.sym} 320 300 0 0 {name=x1}
C {and.sym} 340 510 0 0 {name=x2}
C {nor.sym} 250 -40 0 0 {name=x4}
C {nor.sym} 250 80 0 0 {name=x6}
C {inverter.sym} -190 -140 1 0 {name=x7}
C {buffer.sym} -80 170 0 0 {name=x8}
C {buffer.sym} -60 380 0 0 {name=x9}
...
C {buffer.sym} 240 -100 0 0 {name=x3}
C {buffer.sym} 250 20 0 0 {name=x5}
